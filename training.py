...
def main():
    ...
    X = data[['duration', 'src_bytes', 'serror_rate', 'num_file_creations', 'num_shells', 'service', 'num_failed_logins']]
    y = data['attack']
    ...
    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=.8, train_size=.2, shuffle=True, stratify=y)
